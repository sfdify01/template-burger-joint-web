...
const configData: Config = {
  name: "Tabsy Burgers",
  tagline: "Smash burgers, shakes, and fries.",
  ...
  seo: {
    title: "Tabsy Burgers | Premium Halal Meats & Groceries | Online Ordering",
    description: "Shop Tabsy Burgers for premium halal meats and groceries. Smash burgers, shakes, and fries. Order online for pickup or delivery today.",
    keywords: "halal meat, halal grocery, online ordering, food delivery, pickup, fresh market, halal butcher, naperville, shahirizada"
  },
  announcement: "🍔 Double Cheeseburger Tuesday - Buy one get one free!",
  newsletter: true,
  loyalty: {
    enabled: true,
    earnPerDollar: 10,
